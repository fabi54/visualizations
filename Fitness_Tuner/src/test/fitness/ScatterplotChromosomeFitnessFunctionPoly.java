...
public class ScatterplotChromosomeFitnessFunctionPoly implements FitnessFunction {
...
/*****************************************************************************/	
	...
	public ScatterplotChromosomeFitnessFunctionPoly(ModelSource[] models, DataSource data) {
		this.models = models;
...
/*****************************************************************************/	
	...
	public static double evaluateSimilarity(double[][][] responses) {
		...
		for (int i = 0; i < responses[0].length; i++) {
			...
			similarity += Math.abs(values[values.length - 1] - values[0]);
		}
