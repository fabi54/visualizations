...
public class ScatterplotChromosomeFitnessFunctionNormSim implements FitnessFunction {
...
/*****************************************************************************/	
	...
	public ScatterplotChromosomeFitnessFunctionNormSim(ModelSource[] models, DataSource data) {
		this.models = models;
