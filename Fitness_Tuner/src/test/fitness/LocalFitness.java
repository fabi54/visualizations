...
public class LocalFitness implements FitnessFunction {
...
/*****************************************************************************/	
	...
	public LocalFitness(ModelSource[] models, DataSource data) {
		this.models = models;
...
//		return res;
    ...
    protected static double evaluateGlobal(double[][][] responses, ScatterplotVisualization vis) {
    	return Math.tanh(evaluateSize(vis, responses));
    }
    
    protected static double evaluateLocal(double[][][] responses, ScatterplotVisualization vis) {
    	double res = 0;
