...
public class ScatterplotChromosomeFitnessFunctionSubtrSim implements FitnessFunction {
...
/*****************************************************************************/	
	...
	public ScatterplotChromosomeFitnessFunctionSubtrSim(ModelSource[] models, DataSource data) {
		this.models = models;
...
/*****************************************************************************/	
	...
	protected static final double BOUND = 5000;
