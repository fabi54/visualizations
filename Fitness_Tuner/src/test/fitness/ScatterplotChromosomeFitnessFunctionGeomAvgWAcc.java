...
public class ScatterplotChromosomeFitnessFunctionGeomAvgWAcc implements FitnessFunction {
...
//			for (int j = 0; j < responses.length; j++) {
	...
	public ScatterplotChromosomeFitnessFunctionGeomAvgWAcc(ModelSource[] models, DataSource data) {
		this.models = models;
