...
public class VisibleOutputsList extends JList implements Refreshable {
	...
	public VisibleOutputsList(final ScatterplotVisualization visualization) {
		super(visualization.getOutputNames().toArray());
		...
		listener = new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				visualization.setProperty(ScatterplotVisualization.PROPERTY_OUTPUTS_VISIBLE, res);
			} 
		};
		refresh();
	}
	...
	public void refresh() {
		...
		List<Boolean> selected = visualization.getOutputsVisible();
